...
{
    internal class StairSpiralPreviewConduit : DisplayConduit
    {
        public List<GeometryBase> PreviewGeometry { get; set; } = new List<GeometryBase>();
        public List<StairSpiralPreviewLabel> PreviewLabels { get; set; } = new List<StairSpiralPreviewLabel>();
        public List<StairSpiralPreviewLine> PreviewLines { get; set; } = new List<StairSpiralPreviewLine>();
